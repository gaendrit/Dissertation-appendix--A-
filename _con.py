...
if __name__ == "__main__":
    ...
    meta_path ="/data/home/bt241032/model/data_Image/meta.csv"
    meta_df = pd.read_csv(meta_path)
    test_files = set(meta_df[meta_df['data_split'] == 'Test']['original_image'].tolist())
 

    noisy_dir = '/data/home/bt241032/model/data_Image/Image'
    clean_dir = '/data/home/bt241032/model/data_Image/Mask'
